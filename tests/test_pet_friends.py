...
def test_add_pets_with_valid_data(name='Gosha', animal_type='dog', age='2', pet_photo='images/Gosha.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Tosha', 'dog', '1', 'images/Tosha.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='БарбосбезФото', animal_type='dog', age='6'):
...
def test_add_photo_at_pet(pet_photo='images/Tosha.jpg'):
...
def test_add_pet_negative_age_number(name='Gosha', animal_type='dog', age='-3', pet_photo='images/Gosha.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Gosha', animal_type='dog', age='2548', pet_photo='images/Gosha.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='dog', age='2', pet_photo='images/Gosha.jpg'):
    ...
    status, result = pf.add_new_pets(api_key, name, animal_type, age, pet_photo)
    assert status == 200
    assert result['name'] != '', 'Питомец не добавлен на сайт с пустым значением в имени'


def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='dog', age='2', pet_photo='images/Gosha.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Gosha', animal_type='34562', age='2',
                                                      pet_photo='images/Gosha.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Gosha', age='2', pet_photo='images/Fedor.jpg'):
